...
<!-- =================================================
BEGIN ac_edit_obj_arch_ceramic.tpl
================================================= -->
...
<body class="headerstyle" style="width: 100%; height: 100%; vertical-align: top;">
	{if $query.id ne ""}
		<table class="header" style="width: 90%; margin: auto;"/>
			...
			<tr>
				<td>
					<a href="{$SCRIPT_NAME}?PHPSESSID={$sessionid}&query[id]={$query.id}&query[element]=obj_ceramic_vascularforms">Gef&auml;&szlig;formen</a><p>
					<a href="{$SCRIPT_NAME}?PHPSESSID={$sessionid}&query[id]={$query.id}&query[element]=obj_ceramic_groups">Geographische, stilistische und zeitliche Gruppen</a>
				</td>
			</tr>
			<tr>
				<td style="height: 20px;">
...
<!-- =================================================
END ac_edit_obj_arch_ceramic.tpl
================================================= -->

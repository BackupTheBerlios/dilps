		...
		<tr>
			...
			<td colspan="2" class="result_detail_data_data">
				<table cellpadding="0" cellspacing="0" style="margin:0px; padding: 0px; vertical-align: top;">
            		<tr>
            			<td>
            				<textarea class="inactive" name="edit[functiontype]" cols="47" rows="2" style="width: 300px; height: 40px;" readonly="readonly" >{$row.functiontype|escape:html}</textarea> 
            			</td>
		...
		<tr>
			...
			<td colspan="2" class="result_detail_data_data">
				<table cellpadding="0" cellspacing="0" style="margin:0px; padding: 0px; vertical-align: top;">
            		<tr>
            			<td>
            				<textarea class="inactive" name="edit[formtype]" cols="47" rows="2" style="width: 300px; height: 40px;" readonly="readonly" >{$row.formtype|escape:html}</textarea> 
            			</td>
            			<td style="vertical-align: top;">
		...
		<tr>
			...
			<td colspan="2" class="result_detail_data_data">
				<table cellpadding="0" cellspacing="0" style="margin:0px; padding: 0px; vertical-align: top;">
            		<tr>
            			<td>
            				<textarea class="inactive" name="edit[draught]" cols="47" rows="2" style="width: 300px; height: 40px;" readonly="readonly" >{$row.draught|escape:html}</textarea> 
            			</td>
            			<td style="vertical-align: top;">
		...
		<tr>
			...
			<td colspan="2" class="result_detail_data_data">
				<table cellpadding="0" cellspacing="0" style="margin:0px; padding: 0px; vertical-align: top;">
            		<tr>
            			<td>
            				<textarea class="inactive" name="edit[classification]" cols="47" rows="2" style="width: 300px; height: 40px;" readonly="readonly" >{$row.classification|escape:html}</textarea> 
            			</td>
            			<td style="vertical-align: top;">

...
INSERT INTO `!prefix_!dating_rules` VALUES ('0', 'replace', '', '/fr(ü|ue|u)hes/', 'anfang', '');

INSERT INTO `!prefix_!dating_rules` VALUES ('0', 'replace', '', '/sp(ä|ae|a)tes/', 'ende', '');
...
INSERT INTO `!prefix_!dating_rules` VALUES ('0', 'match', '/^[[:space:]]*spät[[:space:]]*antike[[:space:]]*$/', 'return _GregorianToJD( 1, 1, 275 );', 'return _GregorianToJD( 12, 31, 525 );', 'spätantike == 1.1.275 - 31.12.525');

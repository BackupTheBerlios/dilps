		...
		<table border="0" cellspacing="0" style="width: 100%">			
			<tr>
				...
				<td class="result_list_data_data">
					...
					{/if}
					{if $user.editor}
						<button type="button" name="rot-{$row.collectionid}-{$row.imageid}" class="actionbutton" onclick="javascript:rotateimage('{$row.collectionid}','{$row.imageid}');" style="padding: 1px;" title="{#rotate#|escape:htmlall}"><img src="img/rotate-90.png" style="width: 12px; height: 12px" /></button>
					{/if}
					{if $user.admin}
						<button type="button" name="del-{$row.collectionid}-{$row.imageid}" class="actionbutton" onclick="javascript:deleteimage('{$row.collectionid}','{$row.imageid}');" style="padding: 1px;" title="{#delete#|escape:htmlall}"><img src="img/delete.png" style="width: 12px; height: 12px" /></button>
					{/if}
				</td>
			</tr>
		</table>

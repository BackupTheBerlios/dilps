...
<!-- =================================================
BEGIN ac_edit_obj_epigraphy.tpl
================================================= -->
...
<body class="headerstyle" style="width: 100%; height: 100%; vertical-align: top;">
	...
	{query_ext_element type="archaeology" element="obj_epigraphy" fieldnames="fieldnames" values="values" sql="sql" query=$query}
	...
	<table class="header" style="width: 90%; margin: auto;"/>
		...
		<tr>
			<td>
				<input type="checkbox" name="MSInschrift" value="Inschrift">Inschrift<br>
				<input type="checkbox" name="MSAufschrift" value="Aufschrift">Aufschrift<br>
				<input type="checkbox" name="MSStempelung" value="Stempelung">Stempelung<br>
				<input type="checkbox" name="MSGraffito" value="Graffito">Graffito
				<p>
				<b>n&auml;here Bezeichnung und Text:</b><br>
				
				<textarea name="MSEpigraphikText" rows="5" cols="40">Epigraphik, </textarea>
			</td>
		</tr>
		<tr>
			<td style="height: 20px;">
		...
		<tr>
			<td>
				<table width="0*" border="0" cellspacing="10" cellpadding="0">
					<tr>
						<td><input type="button" value="eingeben" onclick="saveSelection('obj_epigraphy');history.back();"></td>

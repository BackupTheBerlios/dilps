...
<tr>
	...
	<?php 
	   ...
	   $values = "'".$_POST['name']."',"."'".$_POST['host']. "',"."'".$_POST['active']. "',"."'".$_POST['location']. "',"."'".$_POST['description']. "',"."'".$_POST['email']. "',"."'".$_POST['url']. "'";
	   $sql = "insert into {$db_prefix}collection (name, host, active,sammlung_ort,descr,email,url) values (";
	 
	   if ($_POST['id'] != -1) { 
	     $values = "'".$_POST['id']. "',"."'".$_POST['name']."',"."'".$_POST['host']. "',"."'".$_POST['active']. "',"."'".$_POST['location']. "',"."'".$_POST['description']. "',"."'".$_POST['email']. "',"."'".$_POST['url']. "'";

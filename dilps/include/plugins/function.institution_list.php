 ...
 * Smarty plugin
 * -------------------------------------------------------------
 * File:     function.instituion_list.php
 * Type:     function
 * Name:     institution_list
 * Purpose:  assign the institution_list to a template var
 * -------------------------------------------------------------
 */
function smarty_function_institution_list($params, &$smarty)
{
    if (empty($params['var'])) {
    ...
    if (empty($params['city'])) {
        $smarty->trigger_error("assign: missing 'city' parameter");
        return;
    }

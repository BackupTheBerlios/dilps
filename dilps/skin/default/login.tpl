...
<td valign="top">
  ...
  <tr>
     <td class="field_name">{#domain#|escape:"htmlall"}</td>
	  <td><input type="hidden" name="auth[domain]" value="{$config.authdomain|escape:"htmlall"}">{$config.authdomain|escape:"htmlall"}</td>
  </tr>
  <tr>

   ...
   <tr>
	   <td class="result_list_data_img">
	      ...
	      <tr>
	         ...
	         <td width="100%" style="text-align: center; vertical-align: middle;"><a href="javascript:viewDetail('{$sessionid}', '{$row.collectionid}:{$row.imageid}');"><img src="image.php?PHPSESSID={$sessionid}&id={$row.collectionid}:{$row.imageid}&resolution=120x90" border="0"></a></td>
	      </tr>
	      </table>
	   </td>

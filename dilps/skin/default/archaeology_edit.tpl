...
--------------------------------------------- -->
		...
		<tr>
		   ...
		   <td colspan="2" class="result_detail_data_data">
		   		<input type="text" name="edit[title]" size="60" value="{$row.title|escape:html}">
		   	</td>
		</tr>
		<tr>
		...
		<tr>
			...
			<td colspan="2" class="result_detail_data_data">
				...
				<input type="text" name="edit[object]" size="60" value="{$row.object|escape:html}">
			</td>
		</tr>
		<tr>
		...
		<tr>
			<td class="result_detail_data_head">{#iconography#|escape:htmlall}</td>
		   	<td colspan="2" class="result_detail_data_data">
		   		...
		   		<input type="text" name="edit[iconography]" size="60" value="{$row.iconography|escape:htmlall}" readonly="readonly">
		   		[<a onClick="editArchElement( '{$sessionid}', '{$id}', 'iconography', document.Main.elements );">e</a>]
			</td>
		</tr>
		<tr>
			<td class="result_detail_data_head">{#dating_exact#|escape:htmlall}</td>
			<td colspan="2" class="result_detail_data_data">
		   		<input type="text" name="edit[dating]" size="60" value="{$row.dating|escape:html}">
		   	</td>
		</tr>
		<tr>

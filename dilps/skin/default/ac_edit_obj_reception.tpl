...
<body class="headerstyle" style="width: 100%; height: 100%; vertical-align: top;">
	...
	{query_ext_element type="archaeology" element="obj_reception" fieldnames="fieldnames" values="values" sql="sql" query=$query}
	...
	<table class="header" style="width: 90%; margin: auto;"/>
		...
		<tr>
			<td>
				<textarea name="MSRezeptionText" rows="3" cols="50"></textarea>
			</td>
		</tr>
		<tr>
			<td style="height: 20px;">
		...
		<tr>
			<td>
				<table width="0*" border="0" cellspacing="10" cellpadding="0">
					<tr>
						<td><input type="button" value="eingeben" onclick="saveSelection('obj_reception');history.back();"></td>
